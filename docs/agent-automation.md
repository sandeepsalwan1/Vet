...
Intent capsule v7 canonicalizes redirect aliases while retaining exact v1 through v6 reconstruction across route, proof-result, and implementation-label transitions.
