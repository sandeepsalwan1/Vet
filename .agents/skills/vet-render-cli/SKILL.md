---
name: vet-render-cli
description: "Vet Render operations: deploys, logs, SSH, psql, Blueprint validation, auth, CI automation."
license: MIT
metadata:
  author: Render
  version: "1.0.0"
...
- **vet-render-postgres** — Database connections, backups, pooling, and `render psql`
