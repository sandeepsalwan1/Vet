---
name: vet-behavior-validator
description: "Vet source-blind user behavior validation for apps, CLIs, APIs, and proof artifacts."
---

# Behavior Validator

Validate observable behavior without inspecting source.
Use this as the black-box companion to code-aware review: `vet-autoreview` judges the change bundle, while `vet-behavior-validator` judges the running product, CLI, API, or generated artifact against a behavior contract.
