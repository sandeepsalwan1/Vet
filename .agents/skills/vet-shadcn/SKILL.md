---
name: vet-shadcn
description: "Vet shadcn/ui: components, CLI, theming, styling, and composition."
...
Use its JSON for project config and installed components.
...
- **Base Button links use `buttonVariants`.** Do not render an anchor through Base `Button`; it forces `role="button"` onto the link.
