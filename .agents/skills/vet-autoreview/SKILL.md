---
name: vet-autoreview
description: "Vet closeout code review: Codex default; optional Claude, Pi, Droid, Copilot, Cursor, or OpenCode."
---
...
export AUTOREVIEW=".agents/skills/vet-autoreview/scripts/autoreview"
export AUTOREVIEW_HARNESS=".agents/skills/vet-autoreview/scripts/test-review-harness"
```
