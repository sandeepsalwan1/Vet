...
Use Render Dashboard metrics for time-series connection counts.
...
Use Render Dashboard graphs or the documented REST API for disk trends.
Plan cleanup **before** autoscaling steps you cannot immediately reverse (cooldown and no shrink).
