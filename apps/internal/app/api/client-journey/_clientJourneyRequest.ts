...
export type ClientJourneySnapshotLike = {
...
export function hasOutstandingFeedbackPrompt(
  snapshot: ClientJourneySnapshotLike,
...
export async function getClientJourneyResponse(request: Request) {
  try {
...
export async function postClientJourneyResponse(request: Request) {
  try {
