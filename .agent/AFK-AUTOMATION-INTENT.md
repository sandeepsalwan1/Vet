...
Intent capsule v7 applies route canonicalization while legacy v1 through v6 reconstruction accepts the exact historical state across route, proof-result, and implementation-label transitions.
